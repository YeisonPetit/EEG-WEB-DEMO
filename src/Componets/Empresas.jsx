  ...
  return (
    <section className="py-20 bg-linear-to-b from-slate-900 to-slate-950">
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-6 grid-rows-none animate-scroll gap-8">
            {['/src/assets/image.png', '/src/assets/image.png', '/src/assets/image.png' , '/src/assets/image.png', '/src/assets/image.png', '/src/assets/image.png'].map((logo, index) => (
