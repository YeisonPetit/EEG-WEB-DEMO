...
import {
  Briefcase, Users, GraduationCap, Lightbulb, Target, TrendingUp,
  Award, CheckCircle, ArrowRight, Sparkles, BookOpen, Zap,
  Brain, Rocket, Building2, UserCheck, BarChart, MessageSquare,
  ...
  const mainServices = [
    {
      ...
      color: 'orange',
      description: 'Diplomados, maestrías y programas de actualización profesional diseñados para impulsar tu carrera.',
      features: [
    ...
    },
    {
      ...
      color: 'cyan',
      description: 'Capacitación, coaching y consultoría diseñados específicamente para las necesidades de tu organización.',
      features: [
    ...
    },
    {
      ...
      color: 'orange',
      description: 'Metodología dinámica enfocada en generar cambios conductuales y resultados medibles.',
      features: [
    ...
    },
    {
      ...
      color: 'cyan',
      description: 'Acompañamiento experto para alcanzar tus objetivos organizacionales con soluciones holísticas.',
      features: [
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-5xl mx-auto text-center">
            ...
            <p className="text-xl md:text-2xl text-gray-300 max-w-3xl mx-auto">
              Diseñamos experiencias de aprendizaje que generan resultados reales y cambios duraderos en personas y organizaciones
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              {mainServices.map((service, index) => (
                <div
                  key={index}
                  className="group relative bg-gradient-to-br from-slate-900/80 to-slate-900/40 backdrop-blur-sm rounded-3xl p-8 border border-white/10 hover:border-orange-500/30 transition-all duration-300 hover:transform hover:scale-105 cursor-pointer"
                ...
                >
                  ...
                  <div className={`w-16 h-16 rounded-2xl bg-gradient-to-br ${
                    ...
                    <service.icon className={`w-8 h-8 ${
                      service.color === 'orange' ? 'text-orange-400' : 'text-cyan-400'
                    }`} />
                  </div>

                  {/* Contenido */}
                  <h3 className="text-2xl font-bold text-white mb-2">{service.title}</h3>
                  <p className="text-cyan-400 text-sm mb-4">{service.subtitle}</p>
                  <p className="text-gray-300 text-sm mb-6 line-clamp-3">{service.description}</p>

                  {/* Stats */}
                  <div className="flex items-center gap-3 pt-6 border-t border-white/10">
                    <span className="text-3xl font-black text-white">{service.stats.number}</span>
                    <span className="text-xs text-gray-400 uppercase">{service.stats.label}</span>
                  </div>
                ...
                <div>
                  <div className="flex items-center gap-4 mb-6">
                    ...
                    <div>
                      ...
                      <p className="text-cyan-400">{mainServices[selectedService].subtitle}</p>
                    </div>
                  </div>
                  ...
                  <div className="space-y-4">
                    {mainServices[selectedService].features.map((feature, index) => (
                      <div key={index} className="flex items-center gap-3">
                        <div className="w-6 h-6 rounded-full bg-gradient-to-br from-orange-500 to-cyan-500 flex items-center justify-center flex-shrink-0">
                    ...
                    <button
                      ...
                      className={`w-full text-left p-6 rounded-2xl transition-all duration-300 ${
                        selectedService === index
                          ? 'bg-gradient-to-r from-orange-500/20 to-cyan-500/20 border-2 border-orange-500/50 scale-105'
                    ...
                    >
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-4">
                          <service.icon className={`w-8 h-8 ${
                            selectedService === index ? 'text-orange-400' : 'text-gray-400'
                          }`} />
                          <div>
                        ...
                        <ChevronRight className={`w-5 h-5 ${
                          selectedService === index ? 'text-orange-400' : 'text-gray-600'
                        }`} />
                      </div>
                    </button>
                  ))}
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-4xl md:text-5xl font-black text-white text-center mb-16">
              Explora nuestro
              <span className="block text-transparent bg-gradient-to-r from-orange-400 to-cyan-400 bg-clip-text">
                portafolio completo
              </span>
            </h2>
              ...
              {servicioDetallado.map((categoria, catIndex) => (
                <div key={catIndex}>
                  ...
                  <div className="flex items-center gap-4 mb-6">
                    ...
                    <h3 className="text-3xl font-bold text-white">{categoria.category}</h3>
                  </div>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              {beneficios.map((beneficio, index) => (
                ...
                >
                  <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-orange-500/20 to-cyan-500/20 flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform">
          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-gradient-to-br from-orange-500/10 to-cyan-500/10 rounded-3xl p-12 border border-orange-500/20 text-center">
              ...
              <p className="text-xl text-gray-300 mb-8">
                Conversemos sobre cómo nuestros servicios pueden impulsar tu crecimiento
              </p>
