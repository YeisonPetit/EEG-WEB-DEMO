  ...
  con tu exito
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-start max-w-6xl mx-auto">
              ...
              <div className="relative order-2 lg:order-1">
                ...
                <div className="absolute -inset-4 bg-linear-to-br from-orange-500/20 to-cyan-500/20 rounded-3xl blur-3xl -z-10 opacity-60"></div>
              </div>
    ...
    <div className="max-w-6xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
        {stats.map((stat, index) => (
          <div 
            key={index} 
            className="w-full bg-blue-900/30 backdrop-blur-sm rounded-2xl p-6 md:p-8 border border-blue-500/20"
          >
            <div className="flex flex-col sm:flex-row items-start gap-4 mb-4">
              ...
              <div>
                ...
                <h3 className="text-lg md:text-xl font-bold text-white uppercase mt-2 mb-2">
                  {stat.title}
                </h3>
              </div>
            </div>
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="bg-slate-900/50 backdrop-blur-sm rounded-3xl p-8 md:p-12 border border-white/10 mb-12">
              ...
              <div className="mt-8 p-6 bg-linear-to-r from-orange-500/10 to-cyan-500/10 rounded-2xl border border-orange-500/20">
                <div className="flex items-start gap-4">
                  <Quote className="w-3 h-3 md:w-8 md:h-8 text-orange-400 shrink-0 mt-1" />
                  <div>
                    <p className="text-[14px] text-white font-semibold italic mb-2">
